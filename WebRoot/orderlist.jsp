				...
				<td width="25%"><table width="100%" border="0" cellspacing="0"
						...
						<tr>
							<td class="listtd"><img src="${pageContext.request.contextPath }/images/miniicon.gif" width="9"
								height="6" />&nbsp;&nbsp;&nbsp;&nbsp; <a href="${pageContext.request.contextPath }/servlet/orderListServlet">订单查询</a>
							</td>
						</tr>
						<tr>
							<td class="listtd"><img src="${pageContext.request.contextPath }/images/miniicon.gif" width="9"
								height="6" />&nbsp;&nbsp;&nbsp;&nbsp; <a href="${pageContext.request.contextPath }/servlet/logoutServlet">用戶退出</a></td>
						</tr>
							...
							<td style="padding:20px"><p>欢迎${user.username }光临商城！</p>
								...
								<table width="100%" border="0" cellspacing="0" class="tableopen">
									...
									<tr>
										...
										<td class="tableopentd03"><a href="${pageContext.request.contextPath }/servlet/orderItemInfo?orderId=${order.id}">查看</a>&nbsp;&nbsp;
											<a href="#">刪除</a>
										</td>
									</tr>
									</c:forEach>
