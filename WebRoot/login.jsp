...
<script type="text/javascript">
	function changeImage() {
		...
		document.getElementById("img").src = "${pageContext.request.contextPath}/servlet/imageCode?time="
				+ new Date().getTime();
	}
</script>
</head>
													...
													<tr>
														<td style="text-align:center">
															<table width="80%" border="0" cellspacing="0"
																...
																<tr>
																	<td
																		style="text-align:right; padding-top:5px; width:40%">用户名：</td>
																	<td style="text-align:left">
																		<input name="username" type="text" class="textinput" />
																	</td>
																</tr>
																<tr>
																	<td style="text-align:right; padding-top:5px width:40%">密&nbsp;&nbsp;&nbsp;&nbsp;码：</td>
																	<td style="text-align:left">
																		<input name="password" type="password" class="textinput" />
																	</td>
																</tr>
																<tr>
																	<td style="text-align:right;padding-top:5px; width:40%">输入验证码：</td>
																	<td style="text-align:left">
																...
																<tr>
																	...
																	<td colspan="2" style="width:50%"><img
																		src="${pageContext.request.contextPath}/servlet/imageCode" width="180"
																...
																<tr>
																	...
																	<input type="checkbox" name="checkbox" value="checkbox" />
																		记住用户名&nbsp;&nbsp; 
																		<input type="checkbox" name="checkbox" value="checkbox" /> 自动登录</td>
																</tr>
																<tr>
																	<td colspan="2"
