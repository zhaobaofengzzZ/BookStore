...
public static boolean sendMail(String email, String emailMsg) {
		...
		String from = "z17862708639@163.com"; 				// 邮件发送人的邮件地址
		String to = email; 										// 邮件接收人的邮件地址
		final String username = "z17862708639@163.com";  	//发件人的邮件帐户
		final String password = "13183230956zbf";   					//发件人的邮件密码
